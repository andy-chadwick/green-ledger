...
export const policies: Policy[] = [
  {
    ...
    keyStats: [
      ...
      { label: 'Top 1% share of all income tax paid', value: '28.5%', context: 'HMRC 2022-23 — the top 1% pay nearly a third of all income tax collected', comparison: 'The bottom 50% pay just 9.6% — the system is already highly progressive', direction: 'positive' },
      { label: 'Effective tax rate at £100k-£125k', value: '62%', context: 'personal allowance withdrawal creates a 60% income tax rate plus 2% NI', comparison: 'Workers keep just 38p of every extra £1 earned — many stop trying', direction: 'negative' },
    ],
    ...
    debate: [
      ...
      },
      {
        ...
        weSay: 'People earning £100k-£125k already face an effective 62% marginal tax rate because the personal allowance is withdrawn at £1 for every £2 earned. They keep just 38p of each extra pound. IFS research shows measurable "bunching" just below £100k: workers reducing hours, turning down overtime, and diverting income into pensions rather than earn into that band. Data from the Deel platform shows taxable pay clusters sharply below £100k, especially among parents who would also lose 30 hours free childcare. This is not abstract economics. It is 1.8 million real people already responding to incentives by working less. Making the system even more aggressive does not mean the wealthy pay more. It means more people stop trying.',
      },
    ],
  ...
  },
  {
    ...
    keyStats: [
      ...
      { label: 'P5 permanent Security Council members', value: '5 of 5', context: 'all five permanent UN Security Council members are nuclear-armed states', comparison: 'Coincidence or prerequisite? No non-nuclear state has ever held a permanent seat', direction: 'neutral' },
    ],
